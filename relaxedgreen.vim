...
highlight Comment       term=italic       ctermfg=darkgray ctermbg=black                  guifg=#303030 gui=italic
...
highlight TabLine       term=reverse      cterm=reverse ctermfg=black ctermbg=green       guifg=#228822 guibg=#222222
highlight TabLineFill   term=reverse      cterm=reverse ctermfg=green ctermbg=black       guifg=#226622 guibg=#222222
highlight TabLineSel                      ctermfg=black ctermbg=green                     guifg=#222222 guibg=#228822
highlight Title         term=reverse      ctermfg=black ctermbg=green                     guifg=#000000 guibg=#00ff00
highlight Todo          term=reverse      cterm=reverse ctermfg=darkgreen ctermbg=black   guifg=#000000 guibg=#336633
